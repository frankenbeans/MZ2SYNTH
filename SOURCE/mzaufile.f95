...
MODULE MZAUFILE
  ...
  INTEGER(C_INT32_T),PARAMETER :: DFMAGIC=INT(Z'2E736E64')  ! AU TYPE
  INTEGER(C_INT32_T),PARAMETER :: HDRSIZE=28                ! HEADER SIZE
  INTEGER(C_INT32_T),PARAMETER :: DATSIZE=INT(Z'FFFFFFFF')  ! UNKNOWN
...
CONTAINS
  ...
  SUBROUTINE AU_WRTHDR(AUFN,AUFU,ENCD,SMPR,NCHN,MCBE,OVWT,STAT) 
    ...
    OPEN(FILE=AUFN,UNIT=AUFU,FORM='UNFORMATTED',ACCESS='STREAM', &
         ACTION='READWRITE',POSITION='REWIND',STATUS=FSTA,IOSTAT=STAT)
    IF (STAT.NE.0) RETURN
